...
public class MathMethods {
    ...
    //用于创建一个数组，所有的元素都是给定参数。
//    public static Object[] creatArrays(Object object, int length) {
...
//将一个Double[]转换为double[];
    public static double[] doubleArraysFromDouble(Double[] augument) {
        double[] result = new double[augument.length];
        int i=0;
        for (double tmp :
                augument) {
            result[i++]=tmp;
